...
const TOOLS = [
  ...
  },
  {
    ...
    "icon": "🗂️",
    "updated": "2026-08-12",
    "help": "Bulk fetch, delete, dedupe, migrate, and import Zuper records across many modules — jobs, recurring jobs, products, CPQ, workflows and more. Recurring Jobs: delete recurrence definitions with a delete-scope choice — keep the jobs they generated, delete only future ones, or delete every generated job including completed history. Dry Run is on by default for destructive actions. CPQ → 🏠 Roofing CPQ Import: upload one workbook (Measurement Tokens, Formulas, Packages, Bundles sheets) to bulk-create CPQ measurement categories/tokens, formulas (with a confirm-before-apply variable→token mapping grid), service packages, and product bundles — dry-run, dedupe, and rate-limited."
  },
  {
